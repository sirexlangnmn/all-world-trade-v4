...
function getCountryOfOperation(value, elementId) {
    fetch('assets/json/countries.json')
        ...
        .then(function (data) {
            console.log('global-countries.js | getCountryOfOperation(value, elementId)');
            console.log(data);
            console.log(value);
...
function getStatesOfOperation(value, elementId) {
    fetch('assets/json/states.json')
        ...
        .then(function (data) {
            console.log('global-countries.js | function getStatesOfOperation(value, elementId)');
            console.log(data);
            console.log(value);
...
function getCityOfOperation(value, elementId) {
    fetch('assets/json/cities.json')
        ...
        .then(function (data) {
            console.log('global-countries.js | function getCityOfOperation(value, elementId)');
            console.log(data);
            console.log(value);
...
function getRegionOfOperationFunction(value, elementId) {
    ...
    getRegionOfOperations().then((data) => {
        console.log('global-countries.js | function getRegionOfOperationFunction(value, elementId)');
        console.log(data);
        console.log(value);
